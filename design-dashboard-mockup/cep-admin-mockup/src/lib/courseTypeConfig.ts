...
export type CourseType = keyof typeof COURSE_TYPE_CONFIG
 ...
 */
export function getCourseTypeConfig(type: CourseType) {
...
export function getAllCourseTypes(): CourseType[] {
  return Object.keys(COURSE_TYPE_CONFIG) as CourseType[]
}
