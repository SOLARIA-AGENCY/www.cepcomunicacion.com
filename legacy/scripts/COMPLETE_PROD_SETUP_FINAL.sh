...
# 15. Crear script de despliegue de aplicaciones
echo "🚀 Creando script de despliegue de aplicaciones..."
cat > /root/deploy_applications.sh << DEPLOY_SCRIPT
#!/bin/bash

echo "🚀 DESPLEGANDO APLICACIONES CEP COMUNICACIÓN..."
...
# Guardar contraseñas en backup
cat >> /root/backup/app_credentials.txt << APP_CREDS
...
curl -I http://localhost || echo "Frontend no responde"
curl -I http://localhost:3000 || echo "CMS no responde"
curl -I http://localhost:3001 || echo "Admin no responde"

# Verificar HeroCarousel
echo "🎠 Verificando HeroCarousel..."
HERO_CHECK=$(curl -s http://localhost | grep -i "carousel\|hero" || echo "HeroCarousel no encontrado")
if [[ $HERO_CHECK == *"carousel"* ]] || [[ $HERO_CHECK == *"hero"* ]]; then
    echo "✅ HeroCarousel encontrado en frontend"
else
    echo "❌ HeroCarousel no encontrado"
...
chmod +x /root/deploy_applications.sh
echo "✅ Script de despliegue creado"
echo ""

# 16. Crear resumen completo
...
# 17. Mostrar información importante
echo "📋 INFORMACIÓN IMPORTANTE PARA COPIAR:"
echo "===================================="
echo ""
echo "🔑 CONTRASEÑAS:"
...
echo "   $(cat /root/.ssh/server_key.pub)"
echo ""
echo "🔑 CLAVE PRIVADA SSH:"
echo "   $(cat /root/.ssh/server_key)"
echo ""
echo "===================================="
echo ""
...
echo ""
echo "🚀 APLICACIONES:"
echo "   1. Ejecutar: /root/deploy_applications.sh"
echo "   2. Verificar: docker-compose ps"
echo "   3. Verificar: curl -I http://localhost"
echo ""
...
echo "   /root/backup/app_credentials.txt - Credenciales de apps"
