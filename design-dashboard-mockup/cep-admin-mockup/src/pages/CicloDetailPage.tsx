...
import { CICLOS_DETALLE_MOCK } from '@/data/mockCiclos'
import { CursoCicloCard } from '@/components/ui/CursoCicloCard'
...
export function CicloDetailPage() {
  ...
  if (!ciclo) {
    return (
      <div className="text-center py-12">
        ...
        <Button onClick={() => navigate('/ciclos')} className="mt-4">
          Volver a Ciclos
        </Button>
      </div>
    )
  ...
  return (
    <div className="space-y-6">
      {/* Back Button */}
      <Button variant="ghost" onClick={() => navigate('/ciclos')} className="gap-2">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {ciclo.instancias.map((instancia) => (
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2">
                {ciclo.salidas_profesionales.map((salida, idx) => (
