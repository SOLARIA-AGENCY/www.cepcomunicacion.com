...
export const metadata = {
  ...
  description: 'Formación Profesional de Grado Medio y Superior. Ciclos formativos con titulación oficial.',
};
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card">
              ...
              <p className="text-fluid-body text-neutral-700 mb-6 text-center">
                Estamos preparando nuestra oferta de Ciclos Formativos de Grado Medio y Grado Superior.
                Próximamente dispondrás de toda la información sobre especialidades, horarios, requisitos y convocatorias.
              </p>
