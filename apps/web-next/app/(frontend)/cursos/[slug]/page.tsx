...
export default async function CourseDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const cycleName =
    course.cycle && typeof course.cycle === 'object' && 'name' in course.cycle
      ? course.cycle.name
      : null;
    ...
    <div className="course-detail-page bg-neutral-50">
      ...
      >
        <div className="container">
          <div className="max-w-4xl">
            ...
            {/* Title */}
            <h1 className="text-fluid-section-title title-uppercase font-bold mb-4">
              {course.name}
            </h1>

            {/* Description */}
            {course.shortDescription && (
              <p className="text-fluid-body opacity-90 mb-6">{course.shortDescription}</p>
            )}
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {course.short_description && (
                <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                  <h2 className="text-2xl section-title-uppercase font-bold text-neutral-900 mb-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {campuses.map((campus: any) => (
                      <div key={campus.id} className="border border-neutral-200 rounded-lg p-4">
                        ...
                        {campus.city && <p className="text-sm text-neutral-600">{campus.city}</p>}
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
                <h3 className="text-xl card-title-uppercase font-bold text-neutral-900 mb-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-neutral-600">
                          Este curso cuenta con opciones de financiación
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      >
        <div className="container text-center">
          <h2 className="text-2xl section-title-uppercase font-bold text-neutral-900 mb-3">
