    ...
    <div className="space-y-6 w-full">
            ...
            <Card key={kpi.title}>
              ...
              <CardContent>
                ...
                {'total' in kpi && kpi.total && (
                  <p className="text-xs text-muted-foreground">de {kpi.total} totales</p>
                )}
              </CardContent>
            </Card>
          )
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Estadísticas clave de operación</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-2">
              ...
              <div className="h-2 bg-secondary rounded-full overflow-hidden">
                <div className="h-full bg-primary" style={{ width: '78.5%' }}></div>
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium text-muted-foreground">Ingresos por Alumno</p>
              <p className="text-2xl font-bold">
                {Math.floor(metrics.total_revenue / metrics.total_students)}€
              </p>
            </div>
            <div className="space-y-2">
              <p className="text-sm font-medium text-muted-foreground">Promedio por Sede</p>
              <p className="text-2xl font-bold">
                {Math.floor(metrics.total_students / metrics.total_campuses)} alumnos
              </p>
            </div>
          </div>
        </CardContent>
