      ...
      >
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-fluid-hero font-bold mb-4 md:mb-6">Sobre Nosotros</h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-md p-8 md:p-12">
              <h2 className="text-fluid-section-title font-bold mb-6 text-center">
                Nuestra Misión
              </h2>
              <p className="text-fluid-body text-neutral-700 leading-relaxed mb-4">
                En CEP Formación nos dedicamos a proporcionar educación de excelencia que impulse el
                desarrollo profesional y personal de nuestros estudiantes. Creemos en el poder
                transformador de la formación continua y trabajamos para hacer accesible la
                educación de calidad a todos.
              </p>
              <p className="text-fluid-body text-neutral-700 leading-relaxed">
                Nuestro compromiso es ofrecer programas actualizados, docentes expertos y un
                acompañamiento personalizado que garantice el éxito de cada estudiante en su
          ...
          <div className="grid-fluid-features">
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              ...
              <p className="text-neutral-600">
                Buscamos la máxima calidad en todo lo que hacemos, desde nuestros programas hasta el
                trato con nuestros estudiantes.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              ...
              <p className="text-neutral-600">
                Estamos comprometidos con el éxito de nuestros estudiantes y su desarrollo
            ...
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              ...
              <p className="text-neutral-600">
                Adoptamos las últimas tecnologías y metodologías para ofrecer la mejor experiencia
                de aprendizaje.
              </p>
            </div>
          </div>
      ...
      >
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/contacto"
              className="btn-secondary bg-transparent border-2 border-white text-white hover:bg-white hover:text-secondary inline-block"
            >
              Contactar
            </Link>
          </div>
