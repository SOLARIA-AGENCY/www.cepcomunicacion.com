...
export const metadata = {
  ...
  description: 'Cursos subvencionados para personas en situación de desempleo. Formación gratuita con certificación oficial.',
};
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card">
              ...
              <p className="text-fluid-body text-neutral-700 mb-6 text-center">
                Cursos gratuitos financiados por organismos públicos para personas en situación de desempleo.
                Mejora tus competencias profesionales y aumenta tus oportunidades laborales.
              </p>
