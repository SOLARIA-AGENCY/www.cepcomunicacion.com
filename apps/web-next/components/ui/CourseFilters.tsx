...
export function CourseFilters({ courses, onFilteredCoursesChange }: CourseFiltersProps) {
  ...
  const hasActiveFilters = searchText.trim() || selectedArea !== 'todas' || selectedType !== 'todos' || selectedModality !== 'todas';
      ...
      <div className="container py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          ...
          <div className="lg:col-span-2">
            <label htmlFor="search-courses" className="block text-xs font-bold text-neutral-700 mb-2 uppercase tracking-wide">
          ...
          {/* Area Filter */}
          <div>
            <label htmlFor="filter-area" className="block text-xs font-bold text-neutral-700 mb-2 uppercase tracking-wide">
              Filtrar por Área
            </label>
            <select
              id="filter-area"
          ...
          {/* Type Filter */}
          <div>
            <label htmlFor="filter-type" className="block text-xs font-bold text-neutral-700 mb-2 uppercase tracking-wide">
              Filtrar por Tipo
            </label>
            <select
              id="filter-type"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          {/* Modality Filter */}
          <div>
            <label htmlFor="filter-modality" className="block text-xs font-bold text-neutral-700 mb-2 uppercase tracking-wide">
          ...
          <div className="flex items-end">
            ...
            >
              <svg className="w-4 h-4 inline-block mr-2 -mt-0.5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-2 flex items-end">
            <div className="w-full text-center md:text-right text-neutral-600 py-3">
              Mostrando <strong className="text-primary text-lg">{filteredCourses.length}</strong> de {courses.length} cursos
            </div>
          </div>
