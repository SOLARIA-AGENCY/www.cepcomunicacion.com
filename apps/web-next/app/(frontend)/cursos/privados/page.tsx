...
export const metadata = {
  ...
  description:
    'Cursos privados de formación profesional. Amplía tus competencias con formación especializada.',
};
      ...
      >
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-fluid-hero title-hero font-bold mb-4">Cursos Privados</h1>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card">
              ...
              <p className="text-fluid-body text-neutral-700 mb-6 text-center">
                Estamos preparando nuestra oferta de cursos privados con formación especializada en
                diferentes áreas profesionales. Próximamente dispondrás del catálogo completo.
              </p>
