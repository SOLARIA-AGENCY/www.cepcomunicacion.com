          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div>
              <div className="bg-white rounded-xl shadow-md p-6 md:p-8 mb-6">
                <h2 className="text-2xl font-bold text-neutral-900 mb-6">Información de Contacto</h2>
              ...
              <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-xl p-6">
                <h3 className="font-semibold text-neutral-900 mb-3">¿Buscas información sobre cursos?</h3>
