...
import { CicloPlantilla } from '@/types'
...
export function CicloCard({ ciclo, className }: CicloCardProps) {
  ...
  return (
    <Card
      className={`cursor-pointer hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-gray-200 ${className}`}
      style={{ gridColumn: 'span 2' }} // ⭐ ANCHO DOBLE
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              onClick={(e) => {
                e.stopPropagation()
                navigate(`/ciclos/${ciclo.id}/convocatorias`)
              }}
            >
